...
@Entity
@Table(name = "VEHICLE_TBL")   // ✅ your DB table
public class Vehicle {

    @Id
    @Column(name = "VEHICLE_ID", nullable = false)
    private String vehicleID;   // ✅ VH1001 style, so NO @GeneratedValue
    ...
    public double getTotalFuelUsed() { return totalFuelUsed; }
    public void setTotalFuelUsed(double totalFuelUsed) { this.totalFuelUsed = totalFuelUsed; }
