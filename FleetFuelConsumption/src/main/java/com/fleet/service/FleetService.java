...
public class FleetService {
    ...
    // ✅ FULL Hibernate Service (no manual TripID)
    public boolean logTrip(String vehicleID, Date date,
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            Trip t = new Trip();
            // ❌ DO NOT SET tripID (Hibernate will generate)
    ...
    // ✅ FULL Hibernate Service (no manual ExpenseID)
    public boolean recordFuelPurchase(String vehicleID,
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            // ❌ DO NOT SET expenseID (Hibernate will generate)
